...
//           <button onClick={() => onEdit(task)} className="text-blue-500 hover:text-blue-700 text-sm flex items-center gap-1">
//               <FaEdit /> Edit
//             </button>
//             <button onClick={() => onDelete(task._id)} className="text-red-500 ml-2 hover:text-red-700 text-sm flex items-center gap-1">
//               <FaTrash /> Delete
//             </button>
//           </div>
//         </div>
